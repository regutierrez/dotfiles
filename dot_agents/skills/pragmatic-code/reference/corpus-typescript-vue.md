# TypeScript and Vue Source Record

Historical provenance retained from the TypeScript/Vue review skill. The adopted/rejected lists record that skill's synthesis, not a second workflow. Current process and rule admission belong to [corpus.md](corpus.md) and the main skill.
