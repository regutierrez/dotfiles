...
This skill is imported from `dmmulroy/anti-slop`; read [UPSTREAM.md](UPSTREAM.md) before updating its bundled source. The local skill name distinguishes this TypeScript/Oxlint workflow from Python tooling without changing the installed plugin names.
