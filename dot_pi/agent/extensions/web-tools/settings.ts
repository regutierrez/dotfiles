...
export const SEARCH_PROVIDERS = ["exa", "kagi"] as const satisfies readonly SearchProviderName[];
...
const DEFAULTS = {
	...
	searchEnabled: true,
	searchProvider: "kagi",
	searchEndpoint: "https://mcp.kagi.com/mcp",
...
/** Return hardcoded web-tools settings. Kagi search reads its API key from KAGI_API_KEY. */
