		...
		parameters: Type.Object({
			...
			depth: Type.Optional(
				StringEnum([...SEARCH_DEPTHS], {
					description:
						"Search depth. Overrides the web-tools search default depth setting. Kagi ignores this value; Exa maps 'deep' to 'fast'.",
				}),
			),
		}),
...
function createSearchProvider(settings: WebToolsSettings["search"]): SearchProvider {
	switch (settings.provider) {
		...
		case "kagi":
			return new KagiSearchProvider(settings.endpoint);
	}
}
